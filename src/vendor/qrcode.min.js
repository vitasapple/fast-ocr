/**
 * EasyQRCodeJS / QRCode.js standalone offline build
 * Pure JavaScript QRCode generator with 0 dependencies.
 */
(function (root, factory) {
    ...
    QRCodeModel.prototype = {
        addData: function (data) {
            ...
            for (var i = 0, l = data.length; i < l; i++) {
                ...
                parsed.push.apply(parsed, byteArray);
            }
            newData.parsedData = parsed;
    ...
    QRCode.prototype.makeCode = function (sText) {
        this._oQRCode = new QRCodeModel(0, this._htOption.correctLevel);
        ...
        var nCell = Math.floor(nWidth / nCount);
        ...
        var startX = Math.floor((nWidth - nCell * nCount) / 2);
        var startY = Math.floor((nHeight - nCell * nCount) / 2);

        for (var row = 0; row < nCount; row++) {
            for (var col = 0; col < nCount; col++) {
                if (this._oQRCode.isDark(row, col)) {
                    ctx.fillRect(startX + col * nCell, startY + row * nCell, nCell, nCell);
                }
            }
        }
